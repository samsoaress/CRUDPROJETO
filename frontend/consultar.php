...
<body>
    <h1 class="p-3 mb-2 bg-dark text-white text-center bg-opacity-75">Clientes já cadastrados</h1>
    <table class="table table-dark table-striped">
        ...
        <?php while ($dado = $con->fetch_array()) { ?>
            <tr>
                ...
                <td><?php echo "<a class='btn btn-sm btn-primary' href='editar.php?id_pessoa=" . $dado['id_pessoa'] . "'>
